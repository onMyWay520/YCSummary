...
- (CGRect)defaultCardViewFrame {
    ...
    return CGRectMake(
                      kContainerEdage,
    (s_height - (c_height + kCardEdage * 2)) / 2,s_width  - kContainerEdage * 2,c_height);
}
...
- (void)installNextItem {
    ...
    /*self.lastCardFrame = CGRectMake(frame.origin.x,frame.origin.y + 2 * kCardEdage,frame.size.width,frame.size.height);*/
        }}
