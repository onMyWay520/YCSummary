...
//@property (nonatomic, weak)  UISegmentedControl *cacheModeSegmentControl;
@end
...
- (void)buildTestDataThen:(void (^)(void))then {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        // Data from `data.json`
        NSString *dataFilePath = [[NSBundle mainBundle] pathForResource:@"FData" ofType:@"json"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(cell == nil){
    cell = [[FDFeedCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"FDFeedCell"];
    }
